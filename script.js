...
function menu() {
    ...
    document.querySelector("#hamburger").addEventListener("click", function () {
        if (flag === 0) {
            ...
            ).style.transform = `rotate(-45deg) translateY(-10px) translateX(10px)`;
            ...
            document.querySelector(
                "#hamburger>.line:nth-child(2)"
            ).style.transform = `rotate(0deg) translateY(0px) translateX(0px)`;
